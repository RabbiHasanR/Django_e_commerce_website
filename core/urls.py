...
from .views import CheckoutView,HomeView,ProductDetailView,\
    add_to_cart,remove_form_cart,OrderSummaryView,remove_single_item_form_cart,PaymentView,AddCouponView,RequestRefundView
